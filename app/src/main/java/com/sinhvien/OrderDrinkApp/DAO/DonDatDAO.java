...
public class DonDatDAO {
    ...
    public List<DonDatDTO> LayDSDonDat(){
        ...
        while (!cursor.isAfterLast()){
            ...
            donDatDTO.setMaDonDat(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_MADONDAT)));
            donDatDTO.setMaBan(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_MABAN)));
            donDatDTO.setTongTien(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_TONGTIEN)));
            donDatDTO.setTinhTrang(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_TINHTRANG)));
            donDatDTO.setNgayDat(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_NGAYDAT)));
            donDatDTO.setMaNV(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_MANV)));
    ...
    public long LayMaDonTheoMaBan(int maban, String tinhtrang){
        ...
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            magoimon = cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_DONDAT_MADONDAT));

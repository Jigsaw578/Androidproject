...
public class MonDAO {
    ...
    public List<MonDTO> LayDSMonTheoLoai(int maloai){
        ...
        while (!cursor.isAfterLast()){
            ...
            monDTO.setHinhAnh(cursor.getBlob(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_MON_HINHANH)));
            monDTO.setTenMon(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_MON_TENMON)));
            monDTO.setMaLoai(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_MON_MALOAI)));
            monDTO.setMaMon(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_MON_MAMON)));
            monDTO.setGiaTien(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_MON_GIATIEN)));
            monDTO.setTinhTrang(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TBL_MON_TINHTRANG)));
